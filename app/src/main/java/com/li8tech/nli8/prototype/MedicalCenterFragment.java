...
public class MedicalCenterFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GsonRequest<Pojo.Doctor[]> gsonRequest = new GsonRequest<Pojo.Doctor[]>(medcUrl,Pojo.Doctor[].class,new HashMap<String,String>(),createNewAdapter(),handleException(), Request.Method.GET);
    ...
    private Response.Listener<Pojo.Doctor[]> createNewAdapter() {
        return new Response.Listener<Pojo.Doctor[]> () {
            @Override
            public void onResponse(Pojo.Doctor[] response) {
                //
